...
public class FindBookByNumberOfPagesCommand implements Command {
    ...
    private static final String MIN_NUMBER_OF_PAGES_KEY = "minNumberOfPages";
    private static final String MAX_NUMBER_OF_PAGES_KEY = "maxNumberOfPages";
    ...
    public List<Book> execute(Map<String, String> params) throws CommandException {
        ...
        List<Book> bookList;
        try {
            bookList = libraryServiceImpl.findByNumberOfPages(params.get(MIN_NUMBER_OF_PAGES_KEY),
                    params.get(MAX_NUMBER_OF_PAGES_KEY));
