...
public class BookYearOfPublishingComparatorTest {

    private BookYearOfPublishingComparator bookYearOfPublishingComparator;
    private Book bookFirst;
    private Book bookSecond;

    @BeforeMethod
    public void setUp() {
        bookYearOfPublishingComparator = new BookYearOfPublishingComparator();
        bookFirst = new Book();
    ...
    public void testCompare() {
        int actual = bookYearOfPublishingComparator.compare(bookFirst, bookSecond);
        int expected = 1;
