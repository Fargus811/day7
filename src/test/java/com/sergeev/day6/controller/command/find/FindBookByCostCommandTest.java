...
public class FindBookByCostCommandTest {

    private FindBookByCostCommand findBookByCostCommand;
    private Map<String, String> params;

    @BeforeMethod
    public void setUp() {
        findBookByCostCommand = new FindBookByCostCommand();
        params = new HashMap<>();
    ...
    public void testExecute() throws CommandException {
        ...
        findMap.put("minCost", "18");
        findMap.put("maxCost", "28");
        Book book = new Book();
        ...
        expected.add(book);
        List<Book> actual = findBookByCostCommand.execute(findMap);
    ...
    public void testExecuteNoMatches() throws CommandException {
        ...
        addBookCommand.execute(params);
        Map<String, String> findMap = new HashMap<>();
        findMap.put("minCost", "50");
        findMap.put("maxCost", "100");
        List<Book> expected = new ArrayList<>();
        List<Book> actual = findBookByCostCommand.execute(findMap);
        assertEquals(actual, expected);
    }
