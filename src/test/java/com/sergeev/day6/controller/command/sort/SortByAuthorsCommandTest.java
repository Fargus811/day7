...
public class SortByAuthorsCommandTest {
    ...
    private SortByAuthorsCommand sortByAuthorsCommand;
    ...
    @BeforeMethod
    public void setUp() {
        sortByAuthorsCommand = new SortByAuthorsCommand();
        bookFirst = new Book();
        bookSecond = new Book();
    ...
    public void testExecute() {
        ...
        List<Book> actual = sortByAuthorsCommand.execute(new HashMap<>());
