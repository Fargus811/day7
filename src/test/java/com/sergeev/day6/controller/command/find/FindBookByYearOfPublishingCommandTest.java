...
public class FindBookByYearOfPublishingCommandTest {

    private FindBookByYearOfPublishingCommand findBookByYearOfPublishingCommand;
    private Map<String, String> params;

    @BeforeMethod
    public void setUp() {
        findBookByYearOfPublishingCommand = new FindBookByYearOfPublishingCommand();
        params = new HashMap<>();
    ...
    public void testExecute() throws CommandException {
        ...
        expected.add(book);
        List<Book> actual = findBookByYearOfPublishingCommand.execute(findMap);
    ...
    public void testExecuteNoMatches() throws CommandException {
        ...
        addBookCommand.execute(params);
        Map<String, String> findMap = new HashMap<>();
        findMap.put("minYear", "2000");
        findMap.put("maxYear", "2001");
        List<Book> expected = new ArrayList<>();
        List<Book> actual = findBookByYearOfPublishingCommand.execute(findMap);
        assertEquals(actual, expected);
    }
